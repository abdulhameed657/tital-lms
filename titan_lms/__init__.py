    ...
    try:
        with app.app_context():
            ...
            all_migration_stmts = [
                ...
                "ALTER TABLE campuses ALTER COLUMN image_url TYPE TEXT",
                "ALTER TABLE campuses ALTER COLUMN video_url TYPE TEXT",
                "ALTER TABLE courses ALTER COLUMN thumbnail TYPE TEXT",
                "ALTER TABLE events ALTER COLUMN image_url TYPE TEXT",
                "ALTER TABLE course_resources ALTER COLUMN file_url TYPE TEXT",
